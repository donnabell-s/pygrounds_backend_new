...
class QuestionRecalibration(models.Model):
    question = models.ForeignKey("question_generation.GeneratedQuestion", on_delete=models.CASCADE)
    old_difficulty = models.CharField(max_length=50)
    new_difficulty = models.CharField(max_length=50)
    created_at = models.DateTimeField(auto_now_add=True) 
