# Generated by Django 4.2.26 on 2025-11-29 05:40
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to="content_ingestion.documentchunk",
                    ),
                ),
                (
                    "topic",
        ...
        migrations.CreateModel(
            ...
            options={"ordering": ["subtopic__name"],},
        ),
        migrations.CreateModel(
            name="Embedding",
            fields=[
                ...
                (
                    "content_type",
                    models.CharField(
                        choices=[("chunk", "Document Chunk"), ("subtopic", "Subtopic")],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="chunks",
                to="content_ingestion.uploadeddocument",
            ),
        ),
        migrations.CreateModel(
            name="TOCEntry",
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Third level nesting (optional)",
                        max_length=255,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Fourth level nesting (optional, for expert PDFs)",
                        max_length=255,
                        null=True,
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["subtopic"], name="content_ing_subtopi_dad9f8_idx"
            ),
        ),
