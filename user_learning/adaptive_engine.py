...
# New: ordinal + centered difficulty and difficulty-aware modifiers
...
def _impact_with_difficulty(base_impact: float, correct: bool, level: int) -> float:
    """
    For a correct on harder items, slightly increase impact; on easier, slightly decrease.
    For an incorrect, invert the effect (don't over-penalize on hard items).
    Bounds keep it tame: ~±20% at most, and overall impact in [0.5, 5.0].
    """
